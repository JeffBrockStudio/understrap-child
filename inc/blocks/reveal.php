		...
		<div class="container"> 
			<div class="row">
				...
				<div class="col-12">
					...
					<<?php the_sub_field( 'bottom_layer_heading_heading_level' );?> class="heading"><?php the_sub_field( 'bottom_layer_heading_heading' );?></<?php the_sub_field( 'bottom_layer_heading_heading_level' );?>>
